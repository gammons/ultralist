...
var (
	...
	editCmdExample = `  ultralist edit 33 due mon
  Edits the todo 33 and sets the due date to coming Monday.

  ultralist edit 33 due none
  Edits the todo 33 and removes the due date.`
...
var (
  ...
  Edits the 3rd note of the todo with id 33.`
