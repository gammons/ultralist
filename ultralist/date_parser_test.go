...
func TestNone(t *testing.T) {
	assert := assert.New(t)
	dp := &DateParser{}
	date, _ := time.Parse("2006-01-02", "2010-01-01")
...
func TestToday(t *testing.T) {
	...
	formattedRes := res.Format("2006-01-02")
	...
	expectedTime, _ := time.Parse("2006-01-02", "2010-01-01")
	expected := expectedTime.Format("2006-01-02")
...
func TestTomorrow(t *testing.T) {
	...
	expectedTime, _ := time.Parse("2006-01-02", "2010-01-02")
	expected := expectedTime.Format("2006-01-02")
	assert.Equal(expected, formattedRes)
}
...
func TestMondayThisWeek(t *testing.T) {
	assert := assert.New(t)
	dp := &DateParser{}
	date, _ := time.Parse("2006-01-02", "2020-08-16")
	...
	expectedTime, _ := time.Parse("2006-01-02", "2020-08-17")
	expected := expectedTime.Format("2006-01-02")
	assert.Equal(expected, formattedRes)
}
...
func TestMondayNextWeek(t *testing.T) {
	assert := assert.New(t)
	dp := &DateParser{}
	date, _ := time.Parse("2006-01-02", "2020-08-20")
	...
	expectedTime, _ := time.Parse("2006-01-02", "2020-08-24")
	expected := expectedTime.Format("2006-01-02")
	assert.Equal(expected, formattedRes)
}
...
func TestSpecificUSDateAfterPivot(t *testing.T) {
	assert := assert.New(t)
	dp := &DateParser{}
	date, _ := time.Parse("2006-01-02", "2019-08-11")
	...
	formattedRes := res.Format("2006-01-02")
	expectedTime, _ := time.Parse("2006-01-02", "2019-08-12")
	expected := expectedTime.Format("2006-01-02")
	assert.Equal(expected, formattedRes)
}
...
func TestSpecificUSDateBeforePivot(t *testing.T) {
	assert := assert.New(t)
	dp := &DateParser{}
	date, _ := time.Parse("2006-01-02", "2019-08-20")
	...
	formattedRes := res.Format("2006-01-02")
	expectedTime, _ := time.Parse("2006-01-02", "2020-08-12")
	expected := expectedTime.Format("2006-01-02")
	assert.Equal(expected, formattedRes)
}
