...
// }
//
// // Load will load the current todolist from the .todos.json file.
// // it will return an error if the file cannot be loaded.
...
// }
//
// // AddTodo adds a new todo to the current list.  It assumes that a.TodoList has been loaded.
// func (a *App) AddTodo(todo *Todo) {
// 	a.TodoList.Add(todo)
// }
//
...
// }
//
// // ValidateIDs takes an array of todo IDs and validates that they exist in the todo list.
// // It will return an array of ids that are invalid.  If the array is empty, then all todo IDs are valid.
// //
// func (a *App) ValidateIDs(ids ...int) []int {
// }
//
...
// }
//
// // this part needs to go to the CLI class.
// // 		synchronizer := NewQuietSynchronizer()
